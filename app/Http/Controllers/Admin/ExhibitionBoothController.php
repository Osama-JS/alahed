...
class ExhibitionBoothController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'price_before_vat' => 'nullable|numeric|min:0',
            ...
            'price_before_vat.numeric' => 'السعر قبل الضريبة يجب أن يكون رقم',
            'price_before_vat.min' => 'السعر قبل الضريبة يجب أن يكون أكبر من أو يساوي 0',
